    ...
    return (
        <>
            {selectedTopic ? (
                ...
                // Display list of topics for the course
                <div>
                    <Typography gutterBottom variant="h5" component="div" sx={{ fontWeight: 'bold', textAlign: 'center', marginBottom: '20px' }}>
                        Topics
                    </Typography>
                    <Grid container spacing={4} sx={{ padding: '20px' }}>
                        {topics.map((topic) => (
                            <Grid item xs={12} sm={6} md={4} key={topic.id}>
                                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                                    <Card sx={{ maxWidth: 345, boxShadow: '0px 8px 16px rgba(0, 0, 0, 0.1)', transition: '0.3s', borderRadius: '15px', overflow: 'hidden', "&:hover": { boxShadow: '0px 12px 20px rgba(0, 0, 0, 0.2)', transform: 'scale(1.05)', } }}>
                                        <CardMedia component="img" alt={topic.title} height="180" image={topic.image} sx={{ objectFit: 'contain', padding: '10px', background: '#f0f0f0' }} />
                                        <CardContent>
                                            <Typography gutterBottom variant="h5" component="div" sx={{ fontWeight: 'bold' }}>
                                                {topic.title}
                                            </Typography>
                                            ...
                                            <Button size="small" color="primary" onClick={() => setSelectedTopic(topic)}>
                                                Learn More
                                            </Button>
                                        </CardContent>
                                    </Card>
